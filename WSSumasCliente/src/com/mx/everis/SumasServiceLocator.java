...
public class SumasServiceLocator extends org.apache.axis.client.Service implements com.mx.everis.SumasService {
    ...
    private java.lang.String Sumas_address = "http://localhost:8080/WSSumas/services/Sumas";
    ...
    public com.mx.everis.Sumas getSumas(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.mx.everis.SumasSoapBindingStub _stub = new com.mx.everis.SumasSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.mx.everis.Sumas.class.isAssignableFrom(serviceEndpointInterface)) {
                com.mx.everis.SumasSoapBindingStub _stub = new com.mx.everis.SumasSoapBindingStub(new java.net.URL(Sumas_address), this);
                _stub.setPortName(getSumasWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://everis.mx.com", "SumasService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://everis.mx.com", "Sumas"));
        }
